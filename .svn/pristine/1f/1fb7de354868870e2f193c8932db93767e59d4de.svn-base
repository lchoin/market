 ...
 */
@Controller
@RequestMapping("/TbDeliveryAddressApp")
public class TbDeliveryAddressAppController extends BaseAPPController  {
    @Autowired
    ...
    public @ResponseBody
    Map<String, Object> insert(String TokenID,TbDeliveryAddress tbDeliveryAddress) {
    ...
    public @ResponseBody
    Map<String, Object> updateById(String TokenID,TbDeliveryAddress tbDeliveryAddress) {
        Map<String, Object> message = new HashMap<String, Object>();
    ...
    public @ResponseBody
    Map<String, Object> updateById(String TokenID,Long daId) {
        Map<String, Object> message = new HashMap<String, Object>();
    ...
    public @ResponseBody
    Map<String, Object> selectById(String TokenID,Long daId) {
        Map<String, Object> message = new HashMap<String, Object>();
    ...
    public @ResponseBody
    Map<String, Object> settingDefault(String TokenID,Long daId) {
        Map<String, Object> message = new HashMap<String, Object>();
